...
// import { FaGift, FaCalendarAlt, FaInfoCircle, FaRegSmileBeam } from "react-icons/fa";
...
//         </h3>
//         <motion.p
//           className="text-2xl md:text-3xl text-yellow-400 font-semibold px-6 py-4 rounded-lg inline-block"
...
//             <li>Haydovchi sifatida ish boshlang</li>
//             <li><span className="font-bold text-yellow-400">300</span> ta buyurtma bajaring</li>
//             <li>Chekni oling va lototronga tashlang</li>
//             <li><span className="text-yellow-400 font-bold">31-dekabr</span> kuni g‘olib aniqlanadi</li>
//           </ul>
...
//               Aksiya muddati:
//             </p>
//             <b className="text-lg text-gray-800"><span className="text-3xl font-bold text-yellow-400">1</span>-Maydan <span className="text-3xl font-bold text-yellow-400">30</span>-Dekabrgacha</b>
//           </div>
//         </motion.div>
...
//         <p className="flex justify-center items-center text-  gap-2">
//           <FaRegSmileBeam className="text-yellow-300 text-2xl" />
//           Omadingizni sinab ko‘ring va g‘olib bo‘ling!
//         </p>
//       </div>
//       {/* Right flying triangle */}
// <motion.div
//   className="hidden md:block absolute right-0 top-1/3 text-yellow-400 text-3xl opacity-50 z-0"
//   animate={{ y: [0, -20, 0] }}
...
// {/* Left flying triangle */}
// <motion.div
//   className="hidden md:block absolute left-0 top-2/3 text-yellow-400 text-3xl opacity-50 z-0"
//   animate={{ y: [0, 20, 0] }}
//   transition={{ duration: 2, repeat: Infinity, ease: "easeInOut" }}
// >
//   ▼
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col-reverse md:flex-row items-center gap-12 relative overflow-hidden">
        ...
        >
          ...
          <ul className="list-disc list-inside text-gray-700">
            <li>Haydovchi sifatida ish boshlang</li>
            <li>
              <span className="font-bold text-yellow-400">300</span> ta
              buyurtma bajaring
            </li>
            <li>Chekni oling va lototronga tashlang</li>
            <li>
              <span className="text-yellow-400 font-bold">31-dekabr</span> kuni
              g‘olib aniqlanadi
            </li>
          </ul>
