  ...
  return (
    <header className="relative text-white overflow-hidden h-auto md:h-[500px] mt-24" id="home">
      ...
      <div className="hidden md:flex absolute right-[20%] top-1/2 -translate-y-1/2 gap-[3px]">
        <motion.div className="w-[20px] md:w-[40px] h-[300px] md:h-[500px] bg-yellow-400 opacity-50"
          initial={{ opacity: 0 }} animate={{ opacity: 0.5 }} transition={{ duration: 1, delay: 0.5 }} />
        <motion.div className="w-[20px] md:w-[40px] h-[300px] md:h-[500px] bg-yellow-400 opacity-50"
          initial={{ opacity: 0 }} animate={{ opacity: 0.5 }} transition={{ duration: 1, delay: 0.7 }} />
      </div>
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-4">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            >
              ...
              Yandex Go <span className="text-[12px] pt-1">{t("officialPartner")}</span>
            </motion.p>
            ...
            <motion.div className="flex justify-center md:justify-start relative inline-block group" key={`button-${refresh}`}>
              <motion.div
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.05, boxShadow: "0px -2px 10px rgba(255,255,255,0.5)" }}
                whileTap={{ scale: 0.95 }}
          ...
          {/* Mashina rasmi */}
          <motion.div className="flex-1 flex justify-center md:justify-end relative h-[250px] md:h-[375px]">
            <motion.img
              src={moshina}
              alt="moshina"
