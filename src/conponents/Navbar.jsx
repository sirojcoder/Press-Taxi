...
// import logo from "../assets/logo1.jpg"; // Adjust the path as necessary  
...
//   return (
//    <div>
//      <div className="bg-[#FED100] py-[2px]">
//            <div className="flex items-center mx-auto w-10/12 gap-7 space-x-4">
...
//         </div>
//      </div>
//     <div className=" bg-gradient-to-r from-white from-66% to-black  py-2 mx-auto  ">
//       {/* Top info bar */}
    

//       {/* Main navigation */}
//       <div className=" mx-auto w-10/12 flex justify-between items-center py-2">
...
//           <button className="bg-yellow-400 text-black px-6 py-2 text-[18px]   flex items-center hover:bg-white transition-colors duration-300">
//           <IoCarSport color="black" className="w-[30px] h-[20px] " />
//                 PRESS TAXI 
//           </button>
//         </div>
//       </div>
